...
('account_transaction_ingestion_user', 'Account Transaction Ingestion', 'User') -- 11
;
...
('account_transaction_ingestion_household') -- 9
;
...
(9, 11)  -- 6 account_transaction_ingestion with single user
;
...
('account_transaction_ingestion_institution') -- 8
;
...
(6, 4, 'account_transaction_update_name', 'account_transaction_update_nickname'), --3
(7, 5, 'account_transaction_delete_name', 'account_transaction_delete_nickname'), --4
(8, 6, 'account_transaction_ingestion_name', 'account_transaction_ingestion_nickname') --5
;
